"""
Database Seeding Script for AgriMitra
Populates SQLite with realistic demonstration data for all 6 roles:
1. Farmer
2. FPO
3. Buyer
4. Wholesaler
...
def seed_database(force=False):
    ...
    try:
        with conn.cursor() as cursor:
            ...
            # 7. Live Auctions (For FPO and Wholesaler/Distributor Bidding)
            ...
            # Auction 5: Expired/Ended Auction
            cursor.execute("""
                INSERT INTO auctions 
                (lot_code, fpo_id, product_name, category, description, quality_grade, quantity, unit, starting_price, min_increment, current_highest_bid, current_highest_bidder_id, start_time, end_time, status, image_url, hub_location)
                VALUES 
            ...
            # 8. Seed Orders for Buyer and Wholesaler
            cursor.execute("""
